                                ...
                                <div class="p-3 space-y-2">
                                    ...
                                    @else
                                        @foreach($schedules as $slot)
                                            @php
                                                $isSelected = isset($selectedSchedules[$day][$slot['coach_id']]) && $selectedSchedules[$day][$slot['coach_id']] == $slot['id'];
                                            @endphp
                                            <label wire:key="slot-{{ $slot['id'] }}-{{ $slot['coach_id'] }}"
                                                wire:click.prevent="toggleSchedule('{{ $day }}', {{ $slot['coach_id'] }}, {{ $slot['id'] }})"
