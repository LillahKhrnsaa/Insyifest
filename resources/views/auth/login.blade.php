        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <div class="px-8 py-8">
                ...
                <div class="space-y-4 text-center">
                    ...
                    <!-- Admin Login -->
                    <div class="pt-2">
                        <p class="text-xs text-slate-500 mb-3">Akses khusus untuk tim:</p>
                        <a href="/admin" class="inline-flex items-center px-4 py-2.5 border border-slate-300 rounded-xl text-sm font-semibold text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-400 transition-all duration-200 shadow-sm hover:shadow-md">
