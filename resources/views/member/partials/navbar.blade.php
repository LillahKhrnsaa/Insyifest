<nav class="border-b border-white/10 sticky top-0 z-[999] shadow-lg backdrop-blur-md" style="background: linear-gradient(135deg, #1e3a8a 0%, #312e81 100%);">
        ...
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:block">
                    ...
                    <p class="text-[10px] font-bold text-blue-200 uppercase tracking-widest mt-1">Portal Atlet Professional</p>
                </div>
            </div>
                ...
                <div class="flex items-center gap-6">
                    <div class="text-right hidden sm:block border-r border-white/20 pr-6">
                        ...
                        <div class="flex items-center justify-end gap-1.5 mt-0.5">
                            ...
                            <p class="text-[10px] text-blue-200 font-bold uppercase tracking-widest">Active Member</p>
                        </div>
                    </div>
