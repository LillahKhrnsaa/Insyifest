        ...
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:block">
                    ...
                    <p class="text-[10px] font-black text-blue-600 uppercase tracking-widest mt-1">Platform Pelatih Professional</p>
                </div>
            </div>
                ...
                <div class="flex items-center gap-6">
                    <div class="text-right hidden sm:block border-r border-slate-100 pr-6">
                        ...
                        <div class="flex items-center justify-end gap-1.5 mt-0.5">
                            ...
                            <p class="text-[10px] text-slate-400 font-black uppercase tracking-widest">Active Coach</p>
                        </div>
                    </div>
