...
class CoachPolicy
{
    ...
    {
        return $user->can('viewAny.coaches');
    }
    ...
    {
        return $user->can('view.coaches', $coach);
    }
    ...
    {
        return $user->can('create.coaches');
    }
    ...
    {
        return $user->can('update.coaches', $coach);
    }
    ...
    {
        return $user->can('delete.coaches', $coach);
    }
